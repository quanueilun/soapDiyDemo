...
<script>
	$(function() {
		...
		orderMenu.mouseenter(function() {
			$(this).toggleClass("orderMenu_honver");
		}).mouseleave(function() {
			$(this).toggleClass("orderMenu_honver")
		})
		...
		search.eq(1).click(function() {
			...
			$.get("${pageContext.request.contextPath}/order/orderSearch",searchText, 
...
<body>
	...
	<div id="box">
		...
		<div id="content">
			...
			<div id="order-status">
				<ul id="ul-3">
					<li id="All_button" class="orderMenu_normal">全部订单</li>
					<li id="unPay_button" class="orderMenu_normal">待付款</li>
					<li id="unSend_button" class="orderMenu_normal">待发货</li>
					<li id="unGet_button" class="orderMenu_normal">待收货</li>
					<p>
				...
				<table border:"0" cellspacing="0" id="All_list">
					<c:forEach items="${order_All}" var="order" end="10">
						<tr class="order-date">
							...
							<td class="btn"><img src="img/d.png" /><img
