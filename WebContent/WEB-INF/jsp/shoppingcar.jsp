...
<body>
	...
	<div>
		...
		<div style="height:1px;"></div>
            <div id="order-info">
                    	<p style="margin-top:25px;margin-bottom:18px; color:#999;"><a href="#">首页</a>&#8250;&#8250;<a href="#">购物车</a></p>
                 <table border:"0" cellspacing="0"">
                    ...
                    <tr class="order" id="${row.sh_id}">
                        ...
                        <td class="g-info">
                        	<img />
                        	<p class="goods">
                        		<span class="goods-name">${row.good.name}</span>
                        		<br />
                        		<span class="goods-text">${row.good.note}</span>
                        	</p>
                        </td>
                        <td class="p">
                        	<p class="price">
                        		<span>&yen;</span>
                        		<span class="monny">${row.good.price}</span>
                        	</p>
                        </td>
                        <td class="n">
                        	<p class="number">
                        		<input type="number" maxlength="4" value="${row.count}" name="count">
                        	</p>
                       		<div class="xg">修改</div>
                        </td>
                        <td class="s">
                        	<p class="price">
                        		<span>&yen;</span>
                        		<span id="sum" class="monny">${row.good.price * row.count}</span>
                        	</p>
                        </td>
